...
```{r plot-growth, echo = F, fig.cap = "Change in PTSD symptomatology (PCL-5) of a representative sample of 10 patients. The bold black line represents the mean change over all 109 patients. Individual trajectories can be inspecting by double-clicking on a patient's number in the legend on the right of the plot.", eval = T}
